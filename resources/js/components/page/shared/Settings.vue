<template>
    <v-container fluid>
        ...
        <v-btn block color="primary" class="my-2" @click="$router.push({name:'myteams'})" dark>My Teams</v-btn>
        <v-btn block color="primary" class="my-2" @click="$router.push({name:'mymembership'})" dark>My Memberships</v-btn>
