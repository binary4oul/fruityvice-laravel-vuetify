<template>
    <v-container fluid>
        ...
        <v-spacer></v-spacer>
        <template v-if="open">
            <template v-if="personid=='new' || edit==true">
                <v-row>
                    <v-col cols="12" md="6">
...
methods: {
    ...
    selectPhone(phone){
        ...
        this.selectedPhone['personid'] = phone['personid']
    ...
    newPhone(){
        let new_phone = {}
        new_phone['personid'] = this.personid
        new_phone['id'] ='new'
        new_phone['number'] =''
        new_phone['type'] =''
